...
# -*- coding: utf-8 -*-
#
# ESSArch Tools Producer documentation build configuration file, created by
...
project = u'ESSArch Tools Producer'
...
htmlhelp_basename = 'ESSArchToolsProducerdoc'
...
latex_documents = [
    (master_doc, 'ESSArchToolsProducer.tex', u'ESSArch Tools Producer Documentation',
...
man_pages = [
    (master_doc, 'essarchtoolsproducer', u'ESSArch Tools Producer Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ESSArchToolsProducer', u'ESSArch Tools Producer Documentation',
     author, 'ESSArchToolsProducer', 'One line description of project.',
     'Miscellaneous'),
]
